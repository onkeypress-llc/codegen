...
func newTemplateFunction(name string, returnTypes []*TemplateType, args []*TemplateFunctionArg, body *TemplateFunctionBody) (*TemplateFunction, error) {
	if body == nil {
...
func createImportSetForFunction(f *TemplateFunction) (*TemplateImportSet, error) {
	return createImportSetForFunctionComponents(f.Args, f.ReturnTypes)
}

func createImportSetForFunctionComponents(args []*TemplateFunctionArg, returnTypes []*TemplateType) (*TemplateImportSet, error) {
